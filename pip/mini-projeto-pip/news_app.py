...
def cadastro():
    if request.method == "POST":
        ...
        id_nova_atividade = noticias.insert(dados_do_formulario)
        return render_template('cadastro_sucesso.html', id_nova_atividade=id_nova_atividade)
...
def index():
	...
	return render_template('index.html', noticias=todas_as_noticias, title=u"Todas as atividades")


@app.route("/atividade/<int:noticia_id>")
